jQuery( document ).ready(function($) {
	...
	$( '.jd_wpohpost_slider' ).each(function( index ) {
        
		var slider_id   = $(this).attr('id');
		var slider_conf = $.parseJSON( $(this).parent('.wpoh-slider-wrp').find('.wpoh-slider-conf').text() );
		...
		if( typeof(slider_id) != 'undefined' && slider_id != '' ) {
            ...
            jQuery('#'+slider_id).slick({
            	...
            	rtl             : (Bdwpw.is_rtl == "1") ? true : false,
            	mobileFirst     : (Bdwpw.is_mobile == "1") ? true : false,
