<div class="wpoh-post-slides">	
	<div class="wpoh-post-content-position">		
		<div class="wpoh-post-content-left wpoh-medium-6 wpoh-columns">	
			...
			if($show_content == "true") { ?>				
				<div class="wpoh-post-content">
					...
					<a class="wpoh-readmorebtn" href="<?php the_permalink(); ?>"><?php _e('Read More', 'blog-designer-for-wp-post-and-widget'); ?></a>
			...
			<?php } ?>
		</div><!-- end .wpoh-post-content-left -->
